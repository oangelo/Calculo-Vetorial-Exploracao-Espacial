...
Para a avaliação de **slides Reveal.js** (via loop-slides), use o agente **`juiz-slides`** (`.opencode/agent/juiz-slides.md`), que contém os critérios específicos de slides. Este agente é exclusivo de exercícios de sala.
